...
class Generator extends \yii\gii\Generator
{
    ...
    public $viewPath;
    public $baseControllerClass = 'yii\web\BaseController';
        ...
        if ($column->type === 'datetime' || $column->type === 'timestamp') {
            return "
                 \$form->field(\$model, '$attribute')	->widget(DateTimePicker::classname(),
								[
							'name' => '" . StringHelper::basename($this->modelClass) . "[$attribute]',
							'options' => ['placeholder' => 'ОТ','value'=>(\$model->$attribute != null ? date('d.m.Y H:i',strtotime(\$model->$attribute)) : null)],
							'convertFormat' => true,
